...
let btn_about_us = document.querySelector(".btn_about_us"); // кнопка о нас
btn_about_us.addEventListener("click", () => { // при клике на кнопку о нас
  burger.classList.remove("change"); // удаляем класс change
  nav.classList.remove("active"); // удаляем класс active
  document.body.style.overflow = "visible"; // разрешаем прокрутку страницы
...
let btn_app = document.querySelector(".btn_app"); // кнопка приложения
let title_app = document.querySelector(".title_app"); // заголовок приложения
btn_app.addEventListener("click", () => { // при клике на кнопку приложения
  burger.classList.remove("change"); // удаляем класс change
  nav.classList.remove("active"); // удаляем класс active
  document.body.style.overflow = "visible"; // разрешаем прокрутку страницы
